<!-- 原文: source/09a_technical_institutional_challenges.txt (PDF p.97-104) -->
...
**[図: Figure 3.1]** — 汎用AIのリスク管理と政策立案は複数の課題をもたらす（画像: `html/images/fig_3_1.png`）
...
**[図: Figure 3.2]** — 最先端AIモデルの訓練コストは指数関数的に上昇している（画像: `html/images/fig_3_2.png`）
...
**[図: Figure 3.3]** — ほとんどの汎用AIモデルは少数の国から生まれている（画像: `html/images/fig_3_3.png`）
