...
![Figure 3.1: 汎用AIのリスク管理と政策立案は複数の課題をもたらす](../../html/images/fig_3_1.png)
...
![Figure 3.2: 最先端AIモデルの訓練コストは指数関数的に上昇している](../../html/images/fig_3_2.png)
...
![Figure 3.3: ほとんどの汎用AIモデルは少数の国から生まれている](../../html/images/fig_3_3.png)
