<!-- 原文: source/08c1_labour_market.txt (PDF p.84-88) -->
...
**[図: Figure 2.14]** — 米国ではAIは以前の技術よりも速く採用されている（画像: `html/images/fig_2_14.png`）
...
**[図: Figure 2.15]** — 世界のAI採用は非常に不均一である（画像: `html/images/fig_2_15.png`）
