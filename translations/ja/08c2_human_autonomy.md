...
![Figure 2.16: 人間の自律性は複数の次元を持つ](../../html/images/fig_2_16.png)
...
![Figure 2.17: OpenAIのChatGPTの最も一般的な用途は情報検索、文章作成、実用的な助言である](../../html/images/fig_2_17.png)
...
![Figure 2.18: 利用者は様々な理由でAIコンパニオンと関わり、コンパニオンシップは第4位にランクされる](../../html/images/fig_2_18.png)
